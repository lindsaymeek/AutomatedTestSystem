...
;;************************************************************************
;;
;;  DAC_P05.ASM (from DAC6.asm user module template)
;;  Rev C, 2002 Mar 30
;;
...
export  DAC_P05_Start
export _DAC_P05_Start
export  DAC_P05_SetPower
export _DAC_P05_SetPower

export  DAC_P05_WriteBlind
export _DAC_P05_WriteBlind
export  DAC_P05_WriteStall
export _DAC_P05_WriteStall

export  DAC_P05_Stop
export _DAC_P05_Stop
...
_DAC_P05_WriteBlind:
  ...
  ENDIF
  IF DAC_P05_OFFSETBINARY | DAC_P05_TWOSCOMPLEMENT
...
BlindMagSet:
  ...
  ENDIF
    ...
    or   A, DAC_P05_CR0_HIBITS
    mov  reg[DAC_P05_CR0], A
    ret
