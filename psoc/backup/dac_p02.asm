...
;;************************************************************************
;;
;;  DAC_P02.ASM (from DAC6.asm user module template)
;;  Rev C, 2002 Mar 30
;;
...
export  DAC_P02_Start
export _DAC_P02_Start
export  DAC_P02_SetPower
export _DAC_P02_SetPower

export  DAC_P02_WriteBlind
export _DAC_P02_WriteBlind
export  DAC_P02_WriteStall
export _DAC_P02_WriteStall

export  DAC_P02_Stop
export _DAC_P02_Stop
...
_DAC_P02_WriteBlind:
  ...
  ENDIF
  IF DAC_P02_OFFSETBINARY | DAC_P02_TWOSCOMPLEMENT
...
BlindMagSet:
  ...
  ENDIF
    ...
    or   A, DAC_P02_CR0_HIBITS
    mov  reg[DAC_P02_CR0], A
    ret
