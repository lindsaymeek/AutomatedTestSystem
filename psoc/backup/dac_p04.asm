...
;;************************************************************************
;;
;;  DAC_P04.ASM (from DAC6.asm user module template)
;;  Rev C, 2002 Mar 30
;;
...
export  DAC_P04_Start
export _DAC_P04_Start
export  DAC_P04_SetPower
export _DAC_P04_SetPower

export  DAC_P04_WriteBlind
export _DAC_P04_WriteBlind
export  DAC_P04_WriteStall
export _DAC_P04_WriteStall

export  DAC_P04_Stop
export _DAC_P04_Stop
...
_DAC_P04_WriteBlind:
  ...
  ENDIF
  IF DAC_P04_OFFSETBINARY | DAC_P04_TWOSCOMPLEMENT
...
BlindMagSet:
  ...
  ENDIF
    ...
    or   A, DAC_P04_CR0_HIBITS
    mov  reg[DAC_P04_CR0], A
    ret
